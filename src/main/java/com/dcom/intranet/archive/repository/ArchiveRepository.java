...
public interface ArchiveRepository extends JpaRepository<Archive, Long> {
    ...
    // 과목명으로 찾기
    Page<Archive> findBySubjectNameContaining(String subjectName, Pageable pageable);
    // 교수명으로 찾기
    Page<Archive> findByProfessorNameContaining(String professorName, Pageable pageable);
